...
public final class SubArrayOfLong {
     ...
     * @return
     */
    public static SubArrayOfLong create(final long[] data) {
     ...
     * @return
     */
    public static SubArrayOfLong create(final long[] data, final int beg,
    ...
    private SubArrayOfLong(final long[] data, final int beg, final int end,
	    final int inc) {
	m_data = data;
	m_beg = beg;
	m_end = end;
     ...
     * @param a
     */
    public void copy(final SubArrayOfLong a) {
	...
	if (m_inc == 1 && a.m_inc == 1)
     ...
     public void copyFrom(final long[] a, int start) {
   ...
   /**
     ...
     * @return
     */
    public SubArrayOfLong range(final int i0, final int i1) {
	return new SubArrayOfLong(m_data, m_beg + i0 * m_inc,
     ...
     * @param tval
     */
    public void set(final long tval) {
	int cur = m_beg;
	if (m_inc == 1)
	    while (cur != m_end)
		m_data[cur++] = tval;
