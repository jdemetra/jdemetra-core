...
public class Arrays2 {
     ...
     * copy.
     */
    public void copy(final double[] sourceArray,
     ...
     */
    public void reverse(final double[] array) {
     ...
     * @param n
     */
    public void reverse(final double[] array, final int start, final int n) {
     ...
     * @param n
     */
    public void reverse(final int[] array, final int start, final int n) {
        int i = start, j = start + n - 1;
        while (i < j) {
            swap(array, i++, j--);
        }
     ...
     * @param n
     */
    public void reverse(final Object[] array, final int start, final int n) {
        int i = start, j = start + n - 1;
        while (i < j) {
            swap(array, i++, j--);
        }
    ...
    public boolean isNullOrEmpty(double[] array) {
        return array == null || array.length == 0;
    }
     ...
     * @return
     */
    public double[] concat(double[]... arrays) {
        int totalLength = 0;
        for (double[] o : arrays) {
     ...
     */
    public double[] compact(final double[] array) {
        int nm = 0;
     ...
     */
    public void shift(double[] array, int shiftsize) {
     ...
     */
    public void shift(double[] array, int shiftsize, int fromIndex, int toIndex) {
        if (shiftsize > 0) {
    ...
    public <T> boolean arrayEquals(T oldValue, T newValue) {
     ...
     * @return
     */
    public <T> List<T> unmodifiableList(T... array) {
