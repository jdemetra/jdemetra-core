...
//    }
//
//    public static Diagnostics create(AdvancedResidualSeasonalityDiagnosticsConfiguration config, SeriesDecomposition<DoubleSeq> rslts) {
//        try {
//            AdvancedResidualSeasonalityDiagnostics test = new AdvancedResidualSeasonalityDiagnostics();
//            DoubleSeq sa = rslts.getSeries(ComponentType.SeasonallyAdjusted, ComponentInformation.Value);
//            DoubleSeq i = rslts.getSeries(ComponentType.Irregular, ComponentInformation.Value);
//            if (sa == null && i == null) {
//                return null;
//            }
