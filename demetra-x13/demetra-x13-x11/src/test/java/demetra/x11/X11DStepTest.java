...
public class X11DStepTest {
    ...
    @Test
    public void testProcess_CalendarSigmaNone() throws Exception {
        String modeName = DecompositionMode.Multiplicative.name();
        String seasonalFilterOptionName = SeasonalFilterOption.S3X3.name();
        int filterLength = 5;
        int frequency = 12;
    ...
    @Test
    public void testProcess_CalendarSigmaAll() throws Exception {
        String modeName = DecompositionMode.Multiplicative.name();
        String seasonalFilterOptionName = SeasonalFilterOption.S3X3.name();
        int filterLength = 5;
        int frequency = 12;
    ...
    @Test
    public void testProcess_CalendarSigmaSignif() throws Exception {
        String modeName = DecompositionMode.Multiplicative.name();
        String seasonalFilterOptionName = SeasonalFilterOption.S3X3.name();
        int filterLength = 5;
        int frequency = 12;
    ...
    @Test
    @Ignore
    public void testProcess_CalendarSigmaSelect() throws Exception {
        String modeName = DecompositionMode.Multiplicative.name();
        String seasonalFilterOptionName = SeasonalFilterOption.S3X3.name();
        int filterLength = 5;
        int frequency = 12;
    ...
    private void process(X11DStep instance, X11Context context, double[] input) throws Exception {
    ...
    private void testD(String modeName, String seasonalFilterOptionName, int filterLength, int frequency, double[] values) throws Exception {
        testD(modeName, seasonalFilterOptionName, filterLength, frequency, values, CalendarSigmaOption.None.name());
    }

    private void testD(String modeName, String seasonalFilterOptionName, int filterLength, int frequency, double[] values, String calendarSigma) throws Exception {
