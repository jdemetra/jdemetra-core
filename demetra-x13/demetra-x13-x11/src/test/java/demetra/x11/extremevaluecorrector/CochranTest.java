...
public class CochranTest {
    ...
    public void CochranTest() {
        ...
        Assert.assertArrayEquals(expectedStandardDeviation, actualStandardDeviation, 0.0001);
    ...
    public void CochranMissingValuesTest() {
        ...
        X11Context context = X11Context.builder()
                ...
                .period(12)
                .build();
        DoubleSeq missingValuesStartEnd = DeprecatedDoubles.extend(INPUT_DS, 6, 6);
