...
public class X11KernelTest_1 {
    ...
    public void testProcess_Add() {
        ...
        demetra.timeseries.TsData tsData = demetra.timeseries.TsData.ofInternal(TsPeriod.monthly(1900, 1), DoubleSequence.ofInternal(WU5636));
        ...
        seasonalFilterOptions.set(2, SeasonalFilterOption.Stable);
        ...
        ec.satoolkit.x11.SeasonalFilterOption[] filterOptions = new ec.satoolkit.x11.SeasonalFilterOption[12];

        for (int i = 0; i < 12; i++) {
            filterOptions[i] = ec.satoolkit.x11.SeasonalFilterOption.S3X5;
        }
        filterOptions[2] = ec.satoolkit.x11.SeasonalFilterOption.Stable;
        oldSpec.setSeasonalFilters(filterOptions);
        ...
        ec.satoolkit.x11.X11Results old_Results = old.process(new TsData(TsFrequency.valueOf(frequency), 1900, 0, WU5636, true));
