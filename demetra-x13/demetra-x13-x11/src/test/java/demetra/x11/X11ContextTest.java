...
public class X11ContextTest {
    ...
    private void makePos(String messages, double[] data) {
        DoubleSequence dsResults = X11Context.makePositivity(DoubleSequence.ofInternal(data));
        ...
        Assert.assertArrayEquals(messages, oldTs.getValues().internalStorage(), dsResults.toArray(), DELTA);
