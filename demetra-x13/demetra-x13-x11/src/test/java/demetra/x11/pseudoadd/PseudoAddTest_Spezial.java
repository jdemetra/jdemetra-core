 ...
 */
public class PseudoAddTest_Spezial {
    ...
    public void test_test() {
        int frequency = 4;
        String seasonal = SeasonalFilterOption.S3X3.name();
        int filterLength = 17;
        String calendar = CalendarSigmaOption.All.name();
        testX11Kernel(modeName, seasonal, filterLength, frequency, WU5637, calendar);
    }
