 ...
 * (twice as fast). <p>Utility class for HTML form encoding. This class contains
 * static methods for converting a String to the
 * <CODE>application/x-www-form-urlencoded</CODE> MIME format. For more
 * information about HTML form encoding, consult the HTML <A
 * HREF="http://www.w3.org/TR/html4/">specification</A>.
 *
 * <p> When encoding a String, the following rules apply:
 *
 * <p> <ul> <li>The alphanumeric characters &quot;
 * <code>a</code>&quot; through &quot;
 * <code>z</code>&quot;, &quot;
 * <code>A</code>&quot; through &quot;
 * <code>Z</code>&quot; and &quot;
 * <code>0</code>&quot; through &quot;
 * <code>9</code>&quot; remain the same. <li>The special characters &quot;
 * <code>.</code>&quot;, &quot;
 * <code>-</code>&quot;, &quot;
 * <code>*</code>&quot;, and &quot;
 * <code>_</code>&quot; remain the same. <li>The space character &quot;
 * <code>&nbsp;</code>&quot; is converted into a plus sign &quot;
 * <code>+</code>&quot;. <li>All other characters are unsafe and are first
 * converted into one or more bytes using some encoding scheme. Then each byte
 * is represented by the 3-character string &quot;
 ...
 * However, for compatibility reasons, if an encoding is not specified, then the
 * default encoding of the platform is used. </ul>
 *
 * <p> For example using UTF-8 as the encoding scheme the string &quot;The
 * string &#252;
 *
 * @foo-bar&quot; would get converted to &quot;The+string+%C3%BC%40foo-bar&quot;
 * because in UTF-8 the character &#252; is encoded as two bytes C3 (hex) and BC
 * (hex), and the character
...
public final class URLEncoder2 {
     ...
     * href="../lang/package-summary.html#charenc">character encoding</a>.
    ...
    public static StringBuilder encode(@NonNull StringBuilder out, @NonNull CharSequence s, @NonNull Charset charset) {
        ...
        for (int i = 0; i < s.length();) {
            ...
            if (dontNeedEncoding.get(c)) {
                ...
                for (byte b : charArrayWriter.getBytes(charset)) {
                    out.append('%');
    ...
    private static class CustomCharArrayWriter {
