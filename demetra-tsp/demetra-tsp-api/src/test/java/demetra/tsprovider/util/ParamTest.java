...
public class ParamTest {
    ...
    private <T> void assertBehavior(Param<DataSource, T> param, T defaultValue, T newValue, Map<String, String> keyValues) {
    ...
    public void testOnString() {
        ...
        String n = "newValue";
        assertBehavior(Param.onString(d, "k"), d, n, ImmutableMap.of("k", n));
    }
    ...
    public void testOnFile() {
        File d = new File("d");
        File n = new File("x");
        assertBehavior(Param.onFile(d, "k"), d, n, ImmutableMap.of("k", n.getPath()));
    }
    ...
    public void testOnEnum() {
        ...
        assertBehavior(Param.onEnum(d, "k"), d, n, ImmutableMap.of("k", n.name()));
    }
    ...
    public void testOnInteger() {
        Integer d = 123;
        Integer n = 456;
        assertBehavior(Param.onInteger(d, "k"), d, n, ImmutableMap.of("k", n.toString()));
    }
    ...
    public void testOnLong() {
        Long d = 123l;
        Long n = 456l;
        assertBehavior(Param.onLong(d, "k"), d, n, ImmutableMap.of("k", n.toString()));
    }
    ...
    public void testOnBoolean() {
        Boolean d = true;
        Boolean n = false;
        assertBehavior(Param.onBoolean(d, "k"), d, n, ImmutableMap.of("k", n.toString()));
    }
    ...
    public void testOnCharset() {
        ...
        assertBehavior(Param.onCharset(d, "k"), d, n, ImmutableMap.of("k", n.name()));
    }
    ...
    public void testOnDataFormat() {
        ...
        assertBehavior(Param.onObsFormat(d, "k1", "k2", "k3"), d, n1, ImmutableMap.of("k1", "", "k2", "dd-MM-yyyy"));
        assertBehavior(Param.onObsFormat(d, "k1", "k2", "k3"), d, n1, ImmutableMap.of("k1", "", "k2", "dd-MM-yyyy", "k3", ""));
        ObsFormat n2 = ObsFormat.of(null, "dd-MM-yyyy", "#");
        assertBehavior(Param.onObsFormat(d, "k1", "k2", "k3"), d, n2, ImmutableMap.of("k1", "", "k2", "dd-MM-yyyy", "k3", "#"));
    }
    ...
    public void testOnDoubleArray() {
        double[] d = {1, 2, 3};
        double[] n = {4, 5, 6};
        assertBehavior(Param.onDoubleArray("k", d), d, n, ImmutableMap.of("k", Arrays.toString(n)));
    }
    ...
    public void testOnObsGathering() {
        ...
        assertBehavior(Param.onObsGathering(defaultValue, "f", "a", "s"), defaultValue, newValue, ImmutableMap.of("f", "Yearly", "a", "Average", "s", "false"));
        assertThatThrownBy(() -> Param.onObsGathering(null, "f", "a", "s")).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> Param.onObsGathering(defaultValue, null, "a", "s")).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> Param.onObsGathering(defaultValue, "f", null, "s")).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> Param.onObsGathering(defaultValue, "f", "a", null)).isInstanceOf(NullPointerException.class);
    }
}
