...
public class TramoSeatsException extends SaException {
    public static final String ERR_CONTEXT = "Invalid context";

    /**
     * 
     */
    public TramoSeatsException()
    {
    }
     ...
     * @param msg
     */
    public TramoSeatsException(String msg) {
	super(msg);
    }
     ...
     */
    public TramoSeatsException(final String message, final Exception innerException) {
     ...
     * @param origin
     */
    public TramoSeatsException(final String msg, final String origin) {
