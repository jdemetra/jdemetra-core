...
public class MixedEndPoints implements IEndPointsProcessor {
     ...
     *
     * @param options     filteroptions to know which are the stabel ones, the
     *                    the last value of thie perio has to be used
     * @param npoints     The number of points that will be copied at the
     *                    beginning
