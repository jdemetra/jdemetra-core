...
//    private boolean first_;
    ...
    public DefaultModelApproximator3() {
    }
...
//            String desc = "Model changed to "+sarima.getSpecification().toString();
//            if (model.isMeanCorrection()) {
//                desc += (" + mean");
//            }
//            context.processingLog.add(ProcessingInformation.info(MODEL_APPROXIMATION,
//                    DefaultModelApproximator3.class.getName(), desc, sarima.clone()));
//        }
    }
...
//    }
    private boolean app_seas(SeatsModel sm, InformationSet info, SeatsContext context) {
        ...
        if (bd == 1 && bp == 1) {// (...)(1 1 x) -> (...)(0 1 1)
            ...
            } else if (cur.bphi(1) < -.3 && sm.hasSignificantSeasonality()) {
    ...
    private boolean app_known(SeatsModel sm, InformationSet info, SeatsContext context) {
        ...
        switch (d) {
            case 0:
                return app_001011(sm, cur, spec, context);
            case 2:
                return app_021011(sm, cur, spec, context);
            default:
                return app_011011(sm, cur, spec, context);
        }
    }
