...
public class UcarimaException extends BaseException {

    private static final long serialVersionUID = 976922745570816599L;
     ...
     * @param origin
     */
    public UcarimaException(final String msg, final String origin) {
	// super(g_origin, g_rmgr.GetString(msg));
	super(msg, origin, 0);
    }
