...
public class SarimaSpecification implements Cloneable {
    ...
    /**
     * Converts a Sarma specification into a Sarima specification,
     * (D=0, BD=0)
    ...
    /**
     * Generates an airline model (0, 1, 1)(0, 1, 1)
     * or (0, 1, 1) if the frequency is higher than 1.
     */
    public void airline(){
        airline (frequency>1);
    }
    ...
    /**
     * Generates an airline model (0, 1, 1)(0, 1, 1)
     * or (0, 1, 1), following the parameter.
	...
	return new BackFilter(getUnitRoots().toPolynomial());
    }
