...
public class TramoException extends BaseException {
    ...
    final static String ESPDIF_E = "Failure in the identification of the differencing oreders";

    final static String HP_E = "HP_E";
     ...
     */
    public TramoException(final String message, final Exception innerException) {
     ...
     * @param origin
     */
    public TramoException(final String msg, final String origin) {
