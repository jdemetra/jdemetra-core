...
public class BartlettApproximation {
    ...
    private LinearModel m_xmodel, m_ymodel;
    ...
    private void initxmodel(final LinearModel model) {
        m_xmodel = model;
        clearx();
    }

    private void initymodel(final LinearModel model) {
        m_ymodel = model;
        cleary();
    }

    private double[] prepare(final LinearModel model) throws ArimaException {
    ...
    private void prepare(final LinearModel x, final LinearModel y)
            throws ArimaException {
