...
public class SymmetricFrequencyResponseDecomposer2 implements ISymmetricFilterDecomposer {
     ...
     *
     */
    public SymmetricFrequencyResponseDecomposer2() {
        m_freq = 12;
    }
     ...
     * @param freq
     */
    public SymmetricFrequencyResponseDecomposer2(final int freq) {
        m_freq = freq;
    }
    ...
    public boolean decompose(final SymmetricFilter sf) {
        ...
        SymmetricFrequencyResponse2 sfr = new SymmetricFrequencyResponse2(sf);
        ...
        solver.setLeastSquaresDivision(true);
        Complex[] r = sfr.roots(solver);
