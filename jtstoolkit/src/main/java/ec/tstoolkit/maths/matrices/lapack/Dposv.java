...
public class Dposv {
     ...
     * 
     * -- LAPACK driver routine (version 3.0) -- Univ. of Tennessee, Univ. of
     ...
     * Purpose =======
     * 
     * DPOSV computes the solution to a real system of linear equations A * X =
     ...
     * 'U', or A = L * L**T, if UPLO = 'L', where U is an upper triangular
     ...
     * symmetric matrix A. If UPLO = 'U', the leading N-by-N upper triangular
     ...
     * the N-by-NRHS right hand side matrix B. On exit, if INFO = 0, the
     ...
     * argument had an illegal value > 0: if INFO = i, the leading minor of
     * order i of A is not positive definite, so the factorization could not be
     * completed, and the solution has not been computed.
     * 
     * =====================================================================
     * 
     * .. External Functions .. LOGICAL LSAME EXTERNAL LSAME .. .. External
     * Subroutines .. EXTERNAL DPOTRF, DPOTRS, XERBLA .. .. Intrinsic Functions
     * .. INTRINSIC MAX .. .. Executable Statements ..
     * 
     * Test the input parameters.
     * 
     * INFO = 0 IF( .NOT.LSAME( UPLO, 'U' ) .AND. .NOT.LSAME( UPLO, 'L' ) ) THEN
     * INFO = -1 ELSE IF( N.LT.0 ) THEN INFO = -2 ELSE IF( NRHS.LT.0 ) THEN INFO
     * = -3 ELSE IF( LDA.LT.MAX( 1, N ) ) THEN INFO = -5 ELSE IF( LDB.LT.MAX( 1,
     * N ) ) THEN INFO = -7 END IF IF( INFO.NE.0 ) THEN CALL XERBLA( 'DPOSV ',
     * -INFO ) RETURN END IF
     * 
     * Compute the Cholesky factorization A = U'*U or A = L*L'.
     * 
     * CALL DPOTRF( UPLO, N, A, LDA, INFO ) IF( INFO.EQ.0 ) THEN
     * 
