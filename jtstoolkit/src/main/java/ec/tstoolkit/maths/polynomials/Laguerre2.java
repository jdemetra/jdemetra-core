...
public class Laguerre2 implements IRootsSolver {
    ...
    private double m_AbsoluteAccuracy = 1E-6;

    private double m_RelativeAccuracy = 1E-14;

    private double m_FunctionValueAccuracy = 1E-15;
    ...
    private int m_maximalIterationCount = 100;
