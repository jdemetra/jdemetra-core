...
public class ContemporaneousSsfDenton extends AbstractMultivariateSsf {
     ...
     * @param nvars
     */
    public ContemporaneousSsfDenton(int nvars) {
        nvars_ = nvars;
    }
     ...
     * @param weights
     */
    public ContemporaneousSsfDenton(List<double[]> weights) {
        if (weights != null) {
     ...
     * @param weights
     */
    public ContemporaneousSsfDenton(double[][] weights) {
        if (weights != null) {
            w_ = weights;
