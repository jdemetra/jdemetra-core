...
public class MultivariateSsfCholette extends AbstractMultivariateSsf {
     ...
     * @param nvars
     */
    public MultivariateSsfCholette(int c, double rho, int nvars) {
        c_ = c;
        rho_ = rho;
        nvars_ = nvars;
    }
     ...
     * @param weights
     */
    public MultivariateSsfCholette(int c, double rho, Collection<double[]> weights) {
        c_ = c;
        rho_ = rho;
        if (weights != null) {
     ...
     * @param weights
     */
    public MultivariateSsfCholette(int c, double rho, double[][] weights) {
        c_ = c;
        rho_ = rho;
        w_ = weights;
