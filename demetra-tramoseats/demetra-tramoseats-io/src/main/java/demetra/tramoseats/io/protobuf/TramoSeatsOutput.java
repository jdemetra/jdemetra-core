...
public class TramoSeatsOutput {
    ...
    public TramoSeatsResultsProtos.TramoSeatsOutput convert(){
        TramoSeatsResultsProtos.TramoSeatsOutput.Builder builder = 
                TramoSeatsResultsProtos.TramoSeatsOutput.newBuilder()
