...
/**
 * <p>
 * Java class for TramoSeatsRequestsType complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="TramoSeatsRequestsType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Item" type="{ec/eurostat/jdemetra/sa/tramoseats}TramoSeatsAtomicRequestType" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name = "TramoSeatsRequests")
@XmlType(name = "TramoSeatsRequestsType", propOrder = {
    "item",
    "context",
    "outputFilter"
})
public class XmlTramoSeatsRequests {

    @XmlElement(name = "Item", required = true)
    protected List<XmlTramoSeatsAtomicRequest> item;
     ...
     *
     * @return possible object is {@link ProcessingContextType }
     *
     */
     ...
     *
     * @param value allowed object is {@link ProcessingContextType }
     *
     */
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the outputFilter property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
