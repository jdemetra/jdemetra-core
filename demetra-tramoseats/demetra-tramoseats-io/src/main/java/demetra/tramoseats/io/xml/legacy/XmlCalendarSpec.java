...
public class XmlCalendarSpec
    ...
    public static XmlCalendarSpec marshal(CalendarSpec v) {
        if (!v.isUsed()) {
            return null;
        }
    ...
    public static boolean marshal(CalendarSpec v, XmlCalendarSpec xml) {
        if (!v.isUsed()) {
            return true;
        }
    ...
    public static CalendarSpec unmarshal(XmlCalendarSpec xml) {
