...
public class XmlAutomaticTradingDaysSpec {
    ...
    public static final boolean marshal(TradingDaysSpec v, XmlAutomaticTradingDaysSpec xml){
        if (!v.isAutomatic()) {
            return false;
        }
    ...
    public static final TradingDaysSpec unmarshal(XmlAutomaticTradingDaysSpec xml){
