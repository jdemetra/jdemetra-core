...
//    public static final XmlRegressionSpec marshal(RegressionSpec v) {
//        boolean used=v.getOutliers().size()>0 || v.getInterventionVariables().size()>0 || v.getRamps().size()>0
//                || v.getUserDefinedVariables().size()>0;
//        if (!used) {
//            return null;
//        }
