...
public class AlgorithmsTest {
    ...
    private static final double[] BUG = new double[]{
0.607860374,-0.582003109,1.50308909,-1.639472735,-0.018834858,-0.199527697,-0.703902704,
        -1.69823126,-0.195350772,-0.006631046,1.649577845,3.25622847,-0.224687234,0.980223033,
        -1.874951599,0.713007639,1.301214724,3.323227246,-0.093367651,1.258696173,6.202931221,
        4.68080468,1.520110761,2.641336349,3.392107801,6.663676864,4.196302279,3.359651409,
        3.387137286,5.419648585,5.829851047,3.17457787,5.537492243,4.6099225,3.969083004,
        4.12846374,3.537234941,8.236451823,1.176112661,5.593005965,2.437187111,3.328889231,
        1.78493164,1.026089475,3.986381412,4.898291458,1.476296278,1.649844187,2.810435356,
        7.599541638,3.452724234,2.874966201,3.160778554,3.794478065,2.686379359,5.077451333,
        1.306447361,6.688615187,3.45137305,4.245386669,5.413741034,7.712331597,2.953541335,
        6.195776072,6.373129986,4.978179932,5.821470142,4.080781204,5.250098305,5.338229293,
        4.868666293,4.270516033,5.663034476,11.47977882,0.99902968,4.439996612,1.349044858,
        4.880256973,3.882240061,3.288034449,3.142011732,4.086476862,5.400507113,-0.454418296,
        3.325340126,7.077379205,-0.098476412,1.180025373,-1.254450272,3.72912725,3.038515958,
        -1.567485785,6.007593417,1.351458377,5.256590724,-0.315407664,2.026702837,3.69320591,
        -2.391087711,1.248532018,1.001429988,5.030219188,0.764263193,2.114609107,3.745806301,
        4.876401681,2.435878188,0.013408245,4.624675842,6.055225577,2.967496712,6.779015685,
        3.514419973,7.975173548,5.08274563,4.302579357,8.261653875,5.982599866,6.932275748,1.144196583 
    };
...
//        System.out.println(DataBlock.ofInternal(model.fullDefaultParameters()));
        ...
        CompositeModelEstimation rslt = model.estimate(M, 1e-9, LikelihoodType.Diffuse, Optimizer.BFGS, false, null);
    ...
    public void testSutse() {
        ...
        CompositeModel model = new CompositeModel();
        model.add(AtomicModels.localLevel("l1", .01, false, 0));
        model.add(AtomicModels.localLinearTrend("lt1", 0, .01, true, false));
        model.add(AtomicModels.seasonalComponent("s1", "Trigonometric", 12, .01, false));
        model.add(AtomicModels.noise("n1", .01, false));
        model.add(AtomicModels.localLevel("l2", .01, false, 0));
        model.add(AtomicModels.localLinearTrend("lt2", 0, .01, true, false));
...
//        System.out.println(DataBlock.ofInternal(model.fullDefaultParameters()));
        ...
        CompositeModelEstimation rslt = model.estimate(M, 1e-15, LikelihoodType.Diffuse, Optimizer.LevenbergMarquardt, false, null);
