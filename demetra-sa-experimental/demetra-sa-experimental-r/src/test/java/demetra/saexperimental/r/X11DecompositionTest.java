...
public class X11DecompositionTest {
    ...
    public void testX11() {
        ...
        assertTrue(r1 != null);
        System.out.println(DoubleSeq.of(r1.getData("d12", double[].class)));
        X11Decomposition.Results r2 = X11Decomposition.dafX11(s, 12, true, 11, 2, "Henderson", 3, "Trapezoidal", 1.5, 2.5);
        assertTrue(r2 != null);
        System.out.println(DoubleSeq.of(r2.getData("d12", double[].class)));
        ...
        assertTrue(r3 != null);
        System.out.println(DoubleSeq.of(r3.getData("d12", double[].class)));
        ...
        assertTrue(r4 != null);
        System.out.println(DoubleSeq.of(r4.getData("d12", double[].class)));
    }
