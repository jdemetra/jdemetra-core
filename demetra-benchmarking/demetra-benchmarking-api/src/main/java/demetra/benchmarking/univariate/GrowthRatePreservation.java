...
public class GrowthRatePreservation {
    ...
    public TsData benchmark(TsData highFreqSeries, TsData aggregationConstraint, AggregationType type) {
        return PROCESSOR.get().benchmark(highFreqSeries, aggregationConstraint, type);
    }
    ...
    public interface Processor {
        ...
        TsData benchmark(TsData highFreqSeries, TsData aggregationConstraint, AggregationType type);
    }
