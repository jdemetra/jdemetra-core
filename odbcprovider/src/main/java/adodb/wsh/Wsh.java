...
abstract class Wsh {
    ...
    @Nonnull
    abstract public BufferedReader exec(@Nonnull String scriptName, @Nonnull String... args) throws IOException;
    ...
    private static final class CScript extends Wsh {
        ...
        public BufferedReader exec(String scriptName, String... args) throws IOException {
            ...
            Process process = Wsh.exec(script, args);
