...
public class GridFactoryImplTest {
    ...
    static GridInput asGrid(Object[][] array) {
    ...
    public void testReadHorizontal() {
        ...
        assertThat(reader.read(asGrid(basic))).isEqualTo(of(HORIZONTAL, "S1", data(MONTHLY, 2010, 0, 3.14, 4.56, 7.89)));
        ...
        assertThat(reader.read(asGrid(withDateHeader))).isEqualTo(of(HORIZONTAL, "S1", data(MONTHLY, 2010, 0, 3.14, 4.56, 7.89)));
        ...
        assertThat(reader.read(asGrid(withoutHeader))).isEqualTo(of(HORIZONTAL, "S1", data(MONTHLY, 2010, 0, 3.14, 4.56, 7.89)));
        ...
        assertThat(reader.read(asGrid(withMultipleHeaders)))
    ...
    public void testReadVertical() {
        ...
        assertThat(reader.read(asGrid(basic))).isEqualTo(of(VERTICAL, "S1", data(MONTHLY, 2010, 0, 3.14, 4.56, 7.89)));
        ...
        assertThat(reader.read(asGrid(withDateHeader))).isEqualTo(of(VERTICAL, "S1", data(MONTHLY, 2010, 0, 3.14, 4.56, 7.89)));
        ...
        assertThat(reader.read(asGrid(withoutHeader))).isEqualTo(of(VERTICAL, "S1", data(MONTHLY, 2010, 0, 3.14, 4.56, 7.89)));
