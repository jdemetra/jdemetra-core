...
//    @BuilderPattern(TradingDaysSelectionModule.class)
//    public static class Builder {
//
//    private static final double DEF_MODEL_EPS = .01, DEF_CONSTRAINT_EPS = .01;
//
//        private ITradingDaysVariable[] alternatives;
//        private ILengthOfPeriodVariable leapYear;
//
//        // thresholds
//        private double pftd = DEF_MODEL_EPS;
//        private double pfdel = DEF_CONSTRAINT_EPS;
//
//        public Builder alternatives(ITradingDaysVariable[] alternatives) {
//            this.alternatives = alternatives;
//            return this;
//        }
//
//        public Builder constraintSignificance(double csig) {
//            this.pfdel = csig;
//            return this;
//        }
//
//        public Builder tdSignificance(double tdsig) {
//            this.pftd = tdsig;
//            return this;
//        }
//
//        public TradingDaysSelectionModule build() {
//            return new TradingDaysSelectionModule(alternatives, pftd, pfdel);
//        }
//    }
//
...
//    private int choice;
//
//     public TradingDaysSelectionModule(ITradingDaysVariable[] td, final double pftd, final double pfdel) {
//        this.pftd = pftd;
//        this.pfdel = pfdel;
//        this.td = td;
//    }
...
//        tdStats = new LikelihoodStatistics[td.length];
//        // Computes the more general model, the parameters are kept in more restrivitve models
//        PreprocessingModel tdm = createModel(context, td[0], LengthOfPeriodType.LeapYear);
//        if (tdm == null) {
//            return false;
//        }
//        tdModel = tdm;
//        LikelihoodStatistics tds = tdm.getEstimation().getStatistics();
//        tdStats[0] = tds;
//        int df = tds.getEffectiveObservationsCount()-tds.getEstimatedParametersCount();
//        sigma = tds.getSsqErr() / df;
//        ntdStats = check(null, LengthOfPeriodType.LeapYear);
//
//        // compute the other models
//        for (int i = 1; i < td.length; ++i) {
//            tdStats[i] = check(td[i], LengthOfPeriodType.LeapYear);
//        }
//
//        calcProb();
//
...
//        GenericTradingDays best = choice < 0 ? null : td[choice];
...
//        F fstat = new F();
//        pdel = new double[td.length - 1];
//        ptd = new double[td.length];
//        bic = new double[td.length + 1];
//
...
//        bic[td.length] = ntdStats.BICC;
//        for (int i = 1; i < ptd.length; ++i) {
//            bic[i] = tdStats[i].BICC;
//            int ncur = td[i].getCount(), nprev = td[i - 1].getCount(), ndel = nprev - ncur;
