...
public class XmlMetaData {
    ...
    public static class Adapter extends XmlAdapter<XmlMetaData, Map<String, String>> {

        @Override
        public Map<String, String> unmarshal(XmlMetaData v) throws Exception {
        ...
        @Override
        public XmlMetaData marshal(Map<String, String> v) throws Exception {
            if (v == null || v.isEmpty()) {
                return null;
            }
    ...
    public static XmlAdapter<XmlMetaData, Map<String, String>> getAdapter() {
        return ADAPTER;
    }
