...
public class HtmlTableCell {
    ...
    public HtmlTableCell(HtmlElement core) {
        this.core = core;
    }
    ...
    @Deprecated
    public HtmlTableCell(HtmlElement core, HtmlStyle... styles) {
        this.core = core;
        this.styles = styles;
    }
    ...
    @Deprecated
    public HtmlTableCell(HtmlElement core, int width, HtmlStyle... styles) {
        this.core = core;
        this.width = width;
        this.styles = styles;
    }
