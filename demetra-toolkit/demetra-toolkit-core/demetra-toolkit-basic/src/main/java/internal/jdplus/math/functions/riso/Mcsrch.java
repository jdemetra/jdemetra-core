 ...
 * file is a translation of Fortran code written by Jorge Nocedal. It is
 * distributed as part of the RISO project. See comments in the file
...
public class Mcsrch {
     ...
     *
     * The parameter
     * <code>stx</code> contains the step with the least function value. The
     * parameter
     * <code>stp</code> contains the current step. It is assumed that the
     * derivative at
     * <code>stx</code> is negative in the direction of the step. If
     * <code>brackt[0]</code> is
     * <code>true</code> when
     * <code>mcstep</code> returns then a minimizer has been bracketed in an
     * interval of uncertainty with endpoints
     * <code>stx</code> and
     * <code>sty</code>. <p>
     *
     * Variables that must be modified by
     * <code>mcstep</code> are implemented as 1-element arrays.
     *
     * @param stx Step at the best step obtained so far. This variable is
     * modified by <code>mcstep</code>.
     * @param fx Function value at the best step obtained so far. This variable
     ...
     * and <code>stp-stx</code> must have opposite signs. This variable is
     * modified by <code>mcstep</code>.
     *
     * @param sty Step at the other endpoint of the interval of uncertainty.
     * This variable is modified by <code>mcstep</code>.
     * @param fy Function value at the other endpoint of the interval of
     * uncertainty. This variable is modified by <code>mcstep</code>.
     * @param dy Derivative at the other endpoint of the interval of
     * uncertainty. This variable is modified by <code>mcstep</code>.
     *
     * @param stp Step at the current step. If <code>brackt</code> is set then
     * on input <code>stp</code> must be between <code>stx</code> and
     * <code>sty</code>. On output <code>stp</code> is set to the new step.
     * @param fp Function value at the current step.
     * @param dp Derivative at the current step.
     *
     * @param brackt Tells whether a minimizer has been bracketed. If the
     * minimizer has not been bracketed, then on input this variable must be        set <code>false</code>. If the minimizer has been
     ...
     * If <code>info</code> is 1, 2, 3, or 4, then the step has been computed
     * successfully. Otherwise <code>info</code> = 0, and this indicates
     * improper input parameters.
     *
     * @author Jorge J. More, David J. Thuente: original Fortran version, as
     * part of Minpack project. Argonne Nat'l Laboratory, June 1983. Robert
     * Dodier: Java translation, August 1997.
     */
    ...
    private double dg = 0, dgm = 0, dginit = 0, dgtest = 0,
            ...
            fy[] = new double[1], fym[] = new double[1], p5 = 0, p66 = 0,
            stx[] = new double[1], sty[] = new double[1], stmin = 0, stmax = 0,
            width = 0, width1 = 0, xtrapf = 0;
    private boolean brackt[] = new boolean[1], stage1 = false;

    /**
     * Minimize a function along a search direction. This code is a Java
     * translation of the function
     * <code>MCSRCH</code> from
     ...
     * the comments from the Fortran code have been pasted in here as well. <p>
     *
     * The purpose of
     * <code>mcsrch</code> is to find a step which satisfies a sufficient
     * decrease condition and a curvature condition. <p>
     *
     * At each stage this function updates an interval of uncertainty with
     * endpoints
     * <code>stx</code> and
     * <code>sty</code>. The interval of uncertainty is initially chosen so that
     * it contains a minimizer of the modified function
     *
     * <pre>
     ...
     *
     * If
     * <code>ftol</code> is less than
     * <code>gtol</code> and if, for example, the function is bounded below,
     * then there is always a step which satisfies both conditions. If no step
     * can be found which satisfies both conditions, then the algorithm usually
     * stops when rounding errors prevent further progress. In this case
     * <code>stp</code> only satisfies the sufficient decrease condition. <p>
     *
     * @author Original Fortran version by Jorge J. More' and David J. Thuente
     * as part of the Minpack project, June 1983, Argonne National Laboratory.
     * Java translation by Robert Dodier, August 1997.
     *
     * @param lbfgs
     * @param n The number of variables.
     *
     * @param x On entry this contains the base point for the line search. On
     * exit it contains <code>x + stp*s</code>.
     *
     * @param f On entry this contains the value of the objective function at
     * <code>x</code>. On exit it contains the value of the objective function
     * at <code>x + stp*s</code>.
     *
     * @param g On entry this contains the gradient of the objective function        at <code>x</code>. On exit it contains the gradient at
     * <code>x + stp*s</code>.
     *
     ...
     *
     * @param xtol Termination occurs when the relative width of the interval of
     * uncertainty is at most <code>xtol</code>.
     *
     * @param maxfev Termination occurs when the number of evaluations of the
     * objective function is at least <code>maxfev</code> by the end of an
     * iteration.
     *
     * @param info This is an output variable, which can have these values: <ul>
     * <li><code>info = 0</code> Improper input parameters. <li>
     * <code>info = -1</code> A return is made to compute the function and
     * gradient. <li><code>info = 1</code> The sufficient decrease condition and
     * the directional derivative condition hold. <li><code>info = 2</code>
     * Relative width of the interval of uncertainty is at
     * most <code>xtol</code>. <li> <code>info = 3</code> Number of function
     * evaluations has reached <code>maxfev</code>. <li><code>info = 4</code>
     * The step is at the lower bound <code>stpmin</code>. <li><code>info
     *            = 5</code> The step is at the upper bound <code>stpmax</code>.
     * <li><code>info = 6</code> Rounding errors prevent further progress. There
     * may not be a step which satisfies the sufficient decrease and curvature
     * conditions. Tolerances may be too small. </ul>
     *
     ...
     */
    public void fn(Lbfgs lbfgs, int n, double[] x, double f, double[] g,
