...
public strictfp class LegacyDoubleDouble implements Serializable,
     ...
     */
    public static final LegacyDoubleDouble  PI                    = new LegacyDoubleDouble(
     ...
     */
    public static final LegacyDoubleDouble  TWO_PI                = new LegacyDoubleDouble(
     ...
     */
    public static final LegacyDoubleDouble  PI_2                  = new LegacyDoubleDouble(
     ...
     */
    public static final LegacyDoubleDouble  E                     = new LegacyDoubleDouble(
     ...
     * valid number.
     */
    public static final LegacyDoubleDouble  NaN                   = new LegacyDoubleDouble(
                                                                               Double.NaN,
                                                                               Double.NaN);
    ...
    private static final LegacyDoubleDouble TEN                   = new LegacyDoubleDouble(
                                                                               10.0);

    private static final LegacyDoubleDouble ONE                   = new LegacyDoubleDouble(
                                                                               1.0);
    ...
    public LegacyDoubleDouble negate() {
        ...
        return new LegacyDoubleDouble(-high, -low);
    }
    ...
    public LegacyDoubleDouble pow(int exp) {
        ...
        LegacyDoubleDouble s = valueOf(1.0);
        int n = Math.abs(exp);
    ...
    public LegacyDoubleDouble rint() {
        ...
        LegacyDoubleDouble plus5 = add(new LegacyDoubleDouble(0.5));
        return plus5.floor();
    }
    ...
    public LegacyDoubleDouble sqrt() {
        ...
        LegacyDoubleDouble diffSq = subtract(axdd.sqr());
    ...
    private LegacyDoubleDouble selfMultiply(LegacyDoubleDouble y) {
        ...
        hy = c - hy;
        ty = y.high - hy;
        c = hx * hy - C + hx * ty + tx * hy + tx * ty + (high * y.low + low * y.high);
        double zhi = C + c;
        hx = C - zhi;
        double zlo = c + hx;
        high = zhi;
