...
/**
 * A List of long's; as full an implementation of the java.util.List interface as
...
public final class LongList {
     ...
     * @param fillvalue
     */
    public LongList(final int initialCapacity, long fillvalue) {
    ...
    public int hashCode() {
        ...
        for (int j = 0; j < limit; j++) {
            hash = (31 * hash) + Long.hashCode(array[ j]);
        }
        return hash;
    }
