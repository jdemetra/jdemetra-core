...
public final class ModellingSpec implements Validatable<ModellingSpec>, ProcSpecification {
    ...
    public static final String METHOD = "demetra.extendedairline";
    ...
    static {
        ...
        HolidaysSpec td = HolidaysSpec.DEFAULT_UNUSED;
    ...
    private static final String SMETHOD = "Demetra-ExtendedAirline";
