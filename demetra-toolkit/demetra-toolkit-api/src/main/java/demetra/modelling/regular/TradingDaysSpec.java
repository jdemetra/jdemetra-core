...
public class TradingDaysSpec {
    ...
    private static final TradingDaysSpec NONE = new TradingDaysSpec(null, null, TradingDaysType.NONE,
            LengthOfPeriodType.None, false, DEF_ADJUST, DEF_SIMPLIFIED, 0, AutoMethod.UNUSED, 0, null, null);
    ...
    public static TradingDaysSpec stockTradingDays(int w, boolean test) {
        return new TradingDaysSpec(null, null, TradingDaysType.TD7,
                LengthOfPeriodType.None, test, DEF_ADJUST, DEF_SIMPLIFIED, w, AutoMethod.UNUSED, 0, null, null);
    }
    ...
    public static TradingDaysSpec stockTradingDays(int w, @NonNull Parameter[] tdcoeff) {
        ...
        return new TradingDaysSpec(null, null, TradingDaysType.TD7,
                LengthOfPeriodType.None, false, DEF_ADJUST, DEF_SIMPLIFIED, w, AutoMethod.UNUSED, 0, tdcoeff, null);
    }
    ...
    public static TradingDaysSpec userDefined(@NonNull String[] vars, boolean test) {
        return new TradingDaysSpec(null, vars, TradingDaysType.NONE,
                LengthOfPeriodType.None, test, DEF_ADJUST, DEF_SIMPLIFIED, 0, AutoMethod.UNUSED, 0, null, null);
    }
    ...
    public static TradingDaysSpec userDefined(@NonNull String[] vars, @NonNull Parameter[] coeff) {
        ...
        return new TradingDaysSpec(null, vars, TradingDaysType.NONE,
                LengthOfPeriodType.None, false, DEF_ADJUST, DEF_SIMPLIFIED, 0, AutoMethod.UNUSED, 0, coeff, null);
    }
    ...
    public static TradingDaysSpec automaticHolidays(String holidays, LengthOfPeriodType lp, AutoMethod automaticMethod, double probabilityForFTest, boolean autoadjust) {
        ...
        return new TradingDaysSpec(holidays, null, TradingDaysType.TD7,
                lp, false, autoadjust, DEF_SIMPLIFIED, 0, automaticMethod, probabilityForFTest, null, null);
    }
    ...
    public static TradingDaysSpec holidays(String holidays, TradingDaysType type, LengthOfPeriodType lp, boolean test, boolean autoadjust) {
        ...
        return new TradingDaysSpec(holidays, null, type,
                lp, test, autoadjust, DEF_SIMPLIFIED, 0, AutoMethod.UNUSED, 0, null, null);
    }
    ...
    public static TradingDaysSpec holidays(String holidays, TradingDaysType type, LengthOfPeriodType lp, Parameter[] ctd, Parameter clp) {
        ...
        return new TradingDaysSpec(holidays, null, type,
                lp, false, false, DEF_SIMPLIFIED, 0, AutoMethod.UNUSED, 0, ctd, clp);
    }
...
//        }
       if (type == TradingDaysType.NONE && lp == LengthOfPeriodType.None) {
        ...
        return new TradingDaysSpec(null, null, type,
                lp, false, DEF_ADJUST, DEF_SIMPLIFIED, 0, AutoMethod.UNUSED, 0, tdcoeff, lpcoeff);
    }
    ...
    public boolean isDefined() {
        return userVariables != null || (stockTradingDays != 0 && !test)
                || ((lengthOfPeriodType != LengthOfPeriodType.None || tradingDaysType != TradingDaysType.NONE)
                && (!test && automaticMethod == AutoMethod.UNUSED));
    }
