...
public class ArimaDictionaries {
    ...
    public final Dictionary SARIMA = AtomicDictionary.builder()
            .name("sarima")
            .item(Item.builder().name(PERIOD).description("period of the seasonal part").outputClass(int.class).build())
            .item(Item.builder().name(P).description("regular autoregressive order").outputClass(int.class).build())
            .item(Item.builder().name(D).description("regular differencing order").outputClass(int.class).build())
            .item(Item.builder().name(Q).description("regular moving-average order").outputClass(int.class).build())
            .item(Item.builder().name(BP).description("seasonal autoregressive order").outputClass(int.class).build())
            .item(Item.builder().name(BD).description("seasonal differencing order").outputClass(int.class).build())
            .item(Item.builder().name(BQ).description("seasonal moving-average order").outputClass(int.class).build())
    ...
    private final Dictionary UCARIMA_DETAILS=AtomicDictionary.builder()
                            .item(Item.builder()
                                    .name(SIZE).description("number of components").outputClass(int.class).build())
                            .build();
