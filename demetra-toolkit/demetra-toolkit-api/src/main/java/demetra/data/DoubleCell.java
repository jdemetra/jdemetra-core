...
public interface DoubleCell extends DoubleReader {
     ...
     */
    public static DoubleCell of(double[] data, int pos, int inc) {
        switch (inc) {
            case 1:
     ...
     * @return 
     */
    public static DoubleCell of(double value) {
...
class DefaultCell implements DoubleCell {
...
class CellP implements DoubleCell {
...
class CellM implements DoubleCell {
...
class SingleCell implements DoubleCell {
