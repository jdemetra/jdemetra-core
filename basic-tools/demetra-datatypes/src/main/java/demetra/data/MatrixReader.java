 ...
 * @author Jean Palate
 */
class MatrixReader implements DoubleMatrix {
    ...
    public DoubleSequence row(int irow) {
        ...
        return new RegularlySpacedDoubles(storage, irow, ncolumns, nrows);
    }
    ...
    public DoubleSequence column(int icolumn) {
        ...
        return new PartialDoubleArray(storage, icolumn * nrows, nrows);
    }
    ...
    public DoubleSequence subDiagonal(int pos) {
        ...
        return new RegularlySpacedDoubles(storage, beg, n, inc);
    }
    ...
    public DoubleSequence diagonal() {
        ...
        return new RegularlySpacedDoubles(storage, 0, n, inc);
    }
    @Override
