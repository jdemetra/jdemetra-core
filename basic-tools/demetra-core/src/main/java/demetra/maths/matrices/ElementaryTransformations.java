...
public class ElementaryTransformations {
    ...
    public static void rowHouseholder(Matrix m) {
        householder(m.rowsIterator());
    }

    public static boolean givensTriangularize(final Matrix X) {
        try {
    ...
    public static boolean fastRowGivens(final DataBlock row, final Matrix X) {
        try {
    ...
    public static boolean fastGivensTriangularize(final Matrix X) {
        try {
    ...
    public static boolean householderTriangularize(final Matrix X) {
        try {
            int r = X.getRowsCount(), c = X.getColumnsCount();
            Matrix L = X;
            do {
