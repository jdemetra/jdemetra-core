...
public class DescriptiveStatistics {
     ...
     * @param ids
     */
    public DescriptiveStatistics(Doubles ids) {
        m_data = new double[ids.length()];
        ids.copyTo(m_data, 0);
        initStats();
    }
    ...
    // / <returns> </returns>
    // / <exception cref="System.Exception">Throws an exception when no toArray are
    ...
    // / <summary>
    // / Returns the toArray as a sorted array of doubles
    // / </summary>
    /**
     * 
     * @return
