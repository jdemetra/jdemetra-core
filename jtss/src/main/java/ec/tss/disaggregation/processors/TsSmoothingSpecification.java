...
public class TsSmoothingSpecification implements IProcSpecification {
    ...
    public static final String PARAM = "param", CNT = "constant", TREND = "trend",
            TYPE = "aggregationtype", MODEL = "model", NFREQ = "nexfrequency", NB = "nb", NF = "nf";
    ...
    public boolean read(InformationSet info) {
        ...
        s = info.get(NFREQ, String.class);
        if (s != null) {
            nfreq_ = TsFrequency.valueOf(s);
        } else {
            return false;
        }
    ...
    public static void fillDictionary(String prefix, Map<String, Class> dic) {
        ...
        dic.put(InformationSet.item(prefix, NFREQ), String.class);
