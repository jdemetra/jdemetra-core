...
import ec.tss.xml.uscb.AbstractXmlArimaModel;
import ec.tss.xml.uscb.AbstractXmlArimaSpec;
import ec.tss.xml.uscb.XmlArimaOrders;
import ec.tss.xml.uscb.XmlArimaPolynomials;
 ...
 */
@XmlType(name = XmlArimaSpec.NAME, namespace="ec/tss.uscb")
public class XmlArimaSpec extends AbstractXmlArimaSpec {
    ...
    @XmlElements(value = {
        @XmlElement(name = "spec", type = XmlArimaOrders.class, namespace="ec/tss.uscb"),
        @XmlElement(name = "model", type = XmlArimaPolynomials.class, namespace="ec/tss.uscb")
    })
