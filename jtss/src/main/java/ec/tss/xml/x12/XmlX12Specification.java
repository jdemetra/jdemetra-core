 ...
 */
@XmlRootElement(name = XmlX12Specification.RNAME)
@XmlType(name = XmlX12Specification.NAME)
public class XmlX12Specification extends AbstractXmlSaSpecification implements IXmlConverter<X13Specification> {

    static final String NAME = "x12SpecType";
    static final String RNAME = "x12Spec";
    @XmlElement
