...
/**
 * <p>Java class for RegArimaRequestsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RegArimaRequestsType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Item" type="{ec/eurostat/jdemetra/sa/tramoseats}RegArimaAtomicRequestType" maxOccurs="unbounded"/&gt;
...
@XmlRootElement(name="RegArimaRequests")
@XmlType(name = "RegArimaRequestsType", propOrder = {
    "item",
    "context",
    "outputFilter"
})
public class XmlRegArimaRequests {

    @XmlElement(name = "Item", required = true)
    protected List<XmlRegArimaAtomicRequest> item;
     ...
     * {@link RegArimaAtomicRequestType }
     * 
     * 
     */
    public List<XmlRegArimaAtomicRequest> getItems() {
        if (item == null) {
            item = new ArrayList<>();
        }
        return this.item;
