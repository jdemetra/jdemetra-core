...
import static internal.util.sql.adodb.AdoContext.CURRENT_CATALOG;
import static internal.util.sql.adodb.AdoContext.IDENTIFIER_CASE_SENSITIVITY;
import static internal.util.sql.adodb.AdoContext.SPECIAL_CHARACTERS;
import static internal.util.sql.adodb.AdoContext.STRING_FUNCTIONS;
import static internal.util.sql.adodb.AdoContext.of;
