...
class SqlTableAsCubeUtil {

    final Collector<? super String, ?, String> LABEL_COLLECTOR = Collectors.joining(", ");

    AllSeriesCursor allSeriesCursor(ResultSet rs, AutoCloseable closeable, ResultSetFunc<String[]> toDimValues, ResultSetFunc<String> toLabel, CubeId ref) {
        return new ResultSetAllSeriesCursor(rs, closeable, toDimValues, toLabel, ref);
    }

    AllSeriesWithDataCursor<Date> allSeriesWithDataCursor(ResultSet rs, AutoCloseable closeable, ResultSetFunc<String[]> toDimValues, ResultSetFunc<Date> toPeriod, ResultSetFunc<Number> toValue, ResultSetFunc<String> toLabel, CubeId ref) {
        return new ResultSetAllSeriesWithDataCursor(rs, closeable, toDimValues, toPeriod, toValue, toLabel, ref);
    }

    SeriesWithDataCursor<Date> seriesWithDataCursor(ResultSet rs, AutoCloseable closeable, ResultSetFunc<Date> toPeriod, ResultSetFunc<Number> toValue, ResultSetFunc<String> toLabel, CubeId ref) {
        return new ResultSetSeriesWithDataCursor(rs, closeable, toPeriod, toValue, toLabel, ref);
    }

    ChildrenCursor childrenCursor(ResultSet rs, AutoCloseable closeable, ResultSetFunc<String> toChild) {
